let questions = [
  ...
  {
    question: 'Where is the right place to put javascript?',
    options: [
      'in the body tag',
      'in the head tag',
      'Both the body and head tag are correct',
    ],
    answer: 2,
  },
  {
    question:
      'What is the correct syntax to add an external javascript file to the script tag?',
